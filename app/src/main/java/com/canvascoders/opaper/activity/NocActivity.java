...
public class NocActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String TAG = "NocActivity";
    private String uid = "";
    ...
    String str_process_id, str_mobile_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(NocActivity.this);
                ...
                handler.post(new Runnable() {
                    public void run() {
                        if (isBiometrix) {
                            ...
                            try {
                                digio.init(NocActivity.this, digioConfig);
...
// RealmController.getInstance().save(new TrackerModel(1, "test " + m, "test 3", "test 4", "test 5", "test 6", "test 7", "test 8"));
    ...
    public void storePDFOnServer(String sss) {
        ...
        if (AppApplication.networkConnectivity.isNetworkAvailable()) {
            Toast.makeText(NocActivity.this, "Please wait we are storing document", Toast.LENGTH_LONG).show();
            ...
            Call<JsonObject> callUpload = ApiClient.getClient().create(ApiInterface.class).StoreNocDocument("Bearer "+sessionManager.getToken(),params);
                    ...
                    if (response != null) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (response.code() == 200) {
                                ...
                                sessionManager.logoutUser(NocActivity.this);
            ...
            Constants.ShowNoInternet(NocActivity.this);
        }
    ...
    private void showAlert() {
        android.support.v7.app.AlertDialog.Builder alertDialog = new android.support.v7.app.AlertDialog.Builder(NocActivity.this);
        alertDialog.setTitle("Vendor E-signing using Aadhaar.");
        alertDialog.setMessage("NOC Document has been signed sucessfully.");
...
//                    commanFragmentCallWithoutBackStack(new GstActivity());
                    ...
                    /*Intent intent = new Intent(NocActivity.this, GstActivity.class);
                    startActivity(intent);*/

                    Intent intent = new Intent(NocActivity.this, ProcessInfoActivity.class);
                    startActivity(intent);
                    finish();


                } else {
                    Intent i = new Intent(NocActivity.this, DashboardActivity.class);
                    startActivity(i);
                    finish();
                }
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_logout) {
            ...
            SessionManager sessionManager = new SessionManager(NocActivity.this);
            sessionManager.logoutUser(NocActivity.this);
        }
        ...
        protected void onPostExecute(String message) {
            ...
            if (message != null) {
                ...
                try {
                    ...
                    Toast.makeText(NocActivity.this, str_mobile_no + "", Toast.LENGTH_LONG).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                ...
                Toast.makeText(NocActivity.this, "Timeout", Toast.LENGTH_LONG).show();
            }
        }
    }
            ...
            try {
                ...
                if (message != null) {
                    ...
                    if (jsonObject.getInt("responseCode") == 200) {
                        ...
                        ProgressBar p = (ProgressBar) findViewById(R.id.activity_thread_progress);
                        p.setVisibility(View.GONE);
                        Toast.makeText(NocActivity.this, jsonObject.getString("message").toLowerCase(), Toast.LENGTH_LONG).show();
                    }

                } else {
                    ProgressBar p = (ProgressBar) findViewById(R.id.activity_thread_progress);
                    p.setVisibility(View.GONE);
                    Toast.makeText(NocActivity.this, "Server could not response,Please try again", Toast.LENGTH_LONG).show();
                }
                ...
                ProgressBar p = (ProgressBar) findViewById(R.id.activity_thread_progress);
                p.setVisibility(View.GONE);
                Toast.makeText(NocActivity.this, "Unable to store with erver", Toast.LENGTH_LONG).show();
            }
    ...
    private void callLogBeforeDigioSign(String documentId) {
        ...
        dataObj.addProperty("method", "NOC Activity");
