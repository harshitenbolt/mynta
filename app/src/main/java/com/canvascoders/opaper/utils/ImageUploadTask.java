...
public class ImageUploadTask extends AsyncTask<Void, Void, String> {
    ...
    public ImageUploadTask(String mUrl, HashMap<String, String> mMap, HashMap<String, String> mfileMap, OnTaskCompleted mTaskCompleteListener) {
        ...
        Log.e("ImageUploadTask", "Calling: " + Url + "Param:" + " File:" + fileMap.toString());
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            if (fileMap != null && fileMap.size() > 0) {
                ...
                String s = multipartRequest(Url,  fileParam, filePath);
                return s;
            }
            return "";
        } catch (IOException e) {
    ...
    protected void onPostExecute(String s) {
        Log.e("UserDetailResult", "" + s);
        listener.onTaskCompleted(s);
        super.onPostExecute(s);
    }

    public String multipartRequest(String urlTo, String filefield, String filepath) throws ParseException, IOException {
