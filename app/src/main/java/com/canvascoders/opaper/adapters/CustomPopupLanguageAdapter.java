...
public class CustomPopupLanguageAdapter extends RecyclerView.Adapter<CustomPopupLanguageAdapter.RecordHolder> {
    ...
    public CustomPopupLanguageAdapter(List<ObjectPopup> vendorTypeList, Context context, RecyclerViewClickListener onTaskCompleted, String type) {
