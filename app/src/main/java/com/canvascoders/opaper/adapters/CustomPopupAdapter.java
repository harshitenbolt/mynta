...
public class CustomPopupAdapter extends RecyclerView.Adapter<CustomPopupAdapter.RecordHolder> {
    ...
    public CustomPopupAdapter(List<ObjectPopup> vendorTypeList, Context context, RecyclerViewClickListener onTaskCompleted,String type) {
