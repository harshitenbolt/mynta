...
public class CustomPopupStoreTypeAdapter extends RecyclerView.Adapter<CustomPopupStoreTypeAdapter.RecordHolder> {
    ...
    public CustomPopupStoreTypeAdapter(List<ObjectPopup> vendorTypeList, Context context, RecyclerViewClickListener onTaskCompleted, String type) {
