...
public class CustomPopupApproachAdapter extends RecyclerView.Adapter<CustomPopupApproachAdapter.RecordHolder> {
    ...
    public CustomPopupApproachAdapter(List<ObjectPopup> vendorTypeList, Context context, RecyclerViewClickListener onTaskCompleted, String type) {
            ...
            public void onClick(View v) {
                ...
                if (cb.isChecked()) {
                    ...
                    if(Type.equalsIgnoreCase("VendorType")){
                        ...
                        onTaskCompleted.SingleClick("Approach",position);
                    }
