...
public class Data {
    ...
    @SerializedName("assessment_verified_by")
    @Expose
    private Integer assessmentVerifiedBy;
    @SerializedName("assessment_verified_date")
    @Expose
    private String assessmentVerifiedDate;
    @SerializedName("assessment_reject_comment")
    @Expose
    private String assessmentRejectComment;
    @SerializedName("store_name")
    @Expose
    private String storeName;
    @SerializedName("assessment_tried_result")
    @Expose
    private List<AssessmentTriedResult> assessmentTriedResult = null;
    ...
    public Integer getAssessmentVerifiedBy() {
        return assessmentVerifiedBy;
    }

    public void setAssessmentVerifiedBy(Integer assessmentVerifiedBy) {
        this.assessmentVerifiedBy = assessmentVerifiedBy;
    }

    public String getAssessmentVerifiedDate() {
        return assessmentVerifiedDate;
    }

    public void setAssessmentVerifiedDate(String assessmentVerifiedDate) {
        this.assessmentVerifiedDate = assessmentVerifiedDate;
    }

    public String getAssessmentRejectComment() {
        return assessmentRejectComment;
    }

    public void setAssessmentRejectComment(String assessmentRejectComment) {
        this.assessmentRejectComment = assessmentRejectComment;
    }
    ...
    public List<AssessmentTriedResult> getAssessmentTriedResult() {
        return assessmentTriedResult;
    }

    public void setAssessmentTriedResult(List<AssessmentTriedResult> assessmentTriedResult) {
        this.assessmentTriedResult = assessmentTriedResult;
    }
