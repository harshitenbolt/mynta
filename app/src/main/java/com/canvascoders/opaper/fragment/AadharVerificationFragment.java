...
public class AadharVerificationFragment extends Fragment implements View.OnClickListener {
    ...
    private void ApiGetTransactionId() {
        mProgressDialog.show();


     /*   Map<String, String> header = new HashMap<>();
        header.put("QT_API_KEY", );
        header.put("QT_AGENCY_ID", );
        ...
        ApiClient.getClient().create(ApiInterface.class).getTransactionId("https://prod.aadhaarapi.com/gateway/esign/init/", /*"application/json",*/ "67c13d33-2b2a-4d33-b9a9-1a5984a4e158", "29e29bc6-6bea-42b9-a489-51c8815b7840", param).enqueue(new Callback<TranscationId1Response>() {
            ...
            public void onResponse(Call<TranscationId1Response> call, Response<TranscationId1Response> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        TranscationId1Response transcationIdResponse = response.body();
                        Toast.makeText(getActivity(), transcationIdResponse.getId(), Toast.LENGTH_LONG).show();
            ...
            @Override
            public void onFailure(Call<TranscationId1Response> call, Throwable t) {
