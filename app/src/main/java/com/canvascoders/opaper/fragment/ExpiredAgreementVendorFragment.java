...
import com.canvascoders.opaper.activity.ResignAgreementActivity;
...
public class ExpiredAgreementVendorFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RecyclerViewClickListener, AdapterView.OnItemSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_expired_agreement_vendor, container, false);
        mcontext = this.getActivity();
        DashboardActivity.settitle("Expired Agreement Vendors");
        Initialize();
        return view;
    }
    ...
    public void SingleClick(String popup, int position) {
        for (int i = 0; i < vendorLists.size(); i++) {
            if (vendorLists.get(i).getProccessId() == position) {
                ...
                Intent i1 = new Intent(getActivity(), ResignAgreementActivity.class);
