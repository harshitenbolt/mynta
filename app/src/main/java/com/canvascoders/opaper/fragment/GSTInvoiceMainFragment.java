 ...
 */
public class GSTInvoiceMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_gstinvoice_main, container, false);
        mcontext = this.getActivity();

        DashboardActivity.settitle(Constants.TITLE_GST_INVOICE_LIST);

        intView();

        rg_vendor_list = (RadioGroup) view.findViewById(R.id.activity_course_rg);
        webView = view.findViewById(R.id.wvGST);
            ...
            try {
                ...
                if (message != null) {
                    ...
                    if (responseCode == 200) {
                       ...
                       // webView.loadUrl("http://drive.google.com/vwebView.setVisibility(View.GONE);iewerng/viewer?embedded=true&url=" + pdf);
            ...
            try {
                ...
                if(jsonObject.has("response")){
                    ...
                    for (int i = 0; i < result.length(); i++) {
                        ...
                        invoice_status = 0;
                        status = o.getString("gst_esign_status");
                        page = 0;
